...
var base16md5 = exports.base16md5 = function(s) {
    return base16.encode(md5.hash(s)).toLowerCase();
};
...
var digest = exports.digest = function(request, password) {
    return H([H(A1(request, password)),
              request.nonce,
              request.nc,
              request.cnonce,
              request.qop,
...
Handler.prototype =
    update(Object.create(AbstractHandler.prototype),
           {
               ...
               isValidDigest: function(request) {
                   var serverdigest = digest(request, this.getPassword(request.username));
                   return serverdigest == request.response;
               }
           });
